...
export function PropertyInfo({ property }: PropertyInfoProps) {
  ...
  const basicInfo = [
    ...
    },
    {
      ...
      value: property.parking && property.parking > 0 ? property.parking.toString() : 'N/A',
      icon: Car,
    },
    {
      label: 'Pisos',
      value: property.floors && property.floors > 0 ? property.floors.toString() : 'N/A',
      icon: Layers,
    },
    {
      label: 'Antigüedad',
      value: property.age && property.age > 0 ? `${property.age} años` : 'Nueva',
      icon: Calendar,
    },
    {
      label: 'Publicado',
      value: property.publishedAt ? property.publishedAt.toLocaleDateString('es-MX') : 'N/A',
      icon: Clock,
    },
  ]
